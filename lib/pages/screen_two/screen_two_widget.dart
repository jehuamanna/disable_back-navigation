...
export 'screen_two_model.dart';

class ScreenTwoWidget extends StatefulWidget {
  const ScreenTwoWidget({Key? key}) : super(key: key);
...
class _ScreenTwoWidgetState extends State<ScreenTwoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScreenTwoModel());
  }
